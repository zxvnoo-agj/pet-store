...
async def admin_list_categories(
    ...
    response_page = 1 if tree else page
    response_page_size = total if tree else page_size
    total_pages = 1 if tree else (total + page_size - 1) // page_size
    ...
    items = _build_tree(categories, cat_dicts) if tree else [
        CategoryResponse(**cat_dict) for cat_dict in cat_dicts
    ]
