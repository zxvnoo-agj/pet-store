...
const otherItems = [
  { icon: HelpCircle, label: '帮助与反馈', color: 'text-gray-500', bg: 'bg-gray-50' },
  { icon: Shield, label: '隐私设置', color: 'text-gray-500', bg: 'bg-gray-50' },
  { icon: Settings, label: '通用设置', color: 'text-gray-500', bg: 'bg-gray-50' },
];
